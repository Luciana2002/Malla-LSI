const materias = [
  ...
  { codigo: "404", nombre: "Redes de Datos", requisitos: ["303"] },
...
function renderMalla() {
  ...
  materias.forEach(materia => {
    ...
    } else if (!materia.requisitos.length || materia.requisitos.every(req => aprobadas.has(req))) {
    ...
    div.onclick = () => {
      if (div.classList.contains("habilitada")) {
